  ...
  static throw(error: any): any {
    switch (true) {
      ...
      case error[0] instanceof ValidationError:
        ...
        return HandlerResponse.getResponse(customErrors, HttpStatus.BAD_REQUEST)
      default:
        console.error(error)
        return HandlerResponse.getResponse(error.message, HttpStatus.INTERNAL_SERVER_ERROR)
    }
  }
}
